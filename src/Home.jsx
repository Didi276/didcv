...
// pour la vitrine de la home — la galerie complète (80 modèles) est sur /templates
  ...
  return (
    <div style={{ fontFamily: '"Satoshi","Inter",system-ui,sans-serif', color: '#111', background: '#fff', minHeight: '100vh' }}>
      <SEO
        ...
        description="DidJob génère votre CV professionnel et votre lettre de motivation en 30 secondes grâce à l'IA. 80 templates, score ATS, offres d'emploi intégrées. Gratuit."
