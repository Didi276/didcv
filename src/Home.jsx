    ...
    <>
      <nav>
        ...
        <div className="nav-btns">
          ...
          <a href="/generate" className="btn-blue">Commencer gratuitement</a>
        </div>
      </nav>
        ...
        <div className="hero">
          <div>
            ...
            <div className="hero-actions">
              <a href="/generate" className="btn-primary-lg">Générer mon CV gratuitement →</a>
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-grid">
          <div className="price-card">
            ...
            <a href="/generate" className="btn-plan btn-plan-free">Commencer gratuitement</a>
          </div>
      ...
      <div className="cta-wrap">
        <div className="cta-box">
          ...
          <a href="/generate" className="btn-white">Générer mon CV gratuitement →</a>
        </div>
      </div>
