...
export function CVTemplateExtra({ cvData, template = 'latitude', color }) {
  const couleur = color || TEMPLATES_EXTRA_META[template]?.couleurDefaut || '#7c3aed'
  switch (template) {
    ...
    default: return <Latitude cvData={cvData} color={couleur} />
  }
}

export {
  Latitude, Monogramme, Infographie, Chapters,
  Blueprint, Reseau, Pastel, Odyssee,
  Origami, Gravure,
  Constellation, Tatami, 
  Aquarelle, Quantum, Storyboard, Institution, 
  Pixel, Panorama, Matrice, 
  Nordic, Facette, 
  Mineral, Atlas, Epure, Victoire,
