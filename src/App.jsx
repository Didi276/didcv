    ...
    <>
      <nav>
        ...
        <div className="nav-btns">
          ...
          <a href="#" className="btn-blue">Commencer gratuitement</a>
        </div>
      </nav>
        ...
        <div className="hero">
          <div>
            ...
            <div className="hero-actions">
              <a href="#" className="btn-primary-lg">Générer mon CV gratuitement →</a>
          ...
          <div className="hero-card">
            ...
            <div className="card-body">
              ...
              <div className="input-row">
                ...
                <div className="textarea-fake">Nous recherchons un(e) développeur(se) React expérimenté(e). Vous maîtrisez TypeScript, les architectures front-end modernes...</div>
              </div>
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-grid">
          <div className="price-card">
            ...
            <a href="#" className="btn-plan btn-plan-free">Commencer gratuitement</a>
          </div>
      ...
      <div className="cta-wrap">
        <div className="cta-box">
          ...
          <a href="#" className="btn-white">Générer mon CV gratuitement →</a>
        </div>
      </div>
